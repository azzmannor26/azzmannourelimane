...
<section id="gallery" className="gallery">
  ...
  <div className="gallery-grid">
    <Image src="/images/gallery1.png" alt="Gallery Image 1" width={300} height={200} />
    <Image src="/images/gallery2.png" alt="Gallery Image 2" width={300} height={200} />
    <Image src="/images/gallery3.png" alt="Gallery Image 3" width={300} height={200} />
  </div>
  {/* "More" button */}
  <div className="gallery-more">
    <Link href="/#gallery" className="btn-primary">More</Link>
  </div>
</section>
