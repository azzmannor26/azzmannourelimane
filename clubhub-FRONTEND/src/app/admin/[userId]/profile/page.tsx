...
const Profile = ({ params }: { params: { userId: string } }) => {
  ...
  const name = searchParams ? searchParams.get("name") || "User" : "User"; 
  ...
  return (
    <AdminLayout userId={userId} name={name} profileImage={profileImage}> {/* Pass userId and name to AdminLayout */}
