...
class Activite extends Model
{
    ...
    protected $fillable = ['administrateur_id', 'titre', 'description', 'age_min', 'age_max', 'type_activite', 'eff_min', 'eff_max', 'nom', 'categorie', 'service', 'photo', 'mode_de_realisation', 'nbre_seance'];
